...
const NavigationBar = () => {
    return (
        <div className="fixed bottom-0 w-full flex items-end justify-center mb-0 lg:mb-4">
            <nav className="bg-blue-600 rounded-3xl w-65 h-12 text-white grid grid-cols-3 justify-items-center items-center lg:w-96">
